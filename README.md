...
团队|姓名|学号|任务分配
--|:--:|:-|--
组长|黄宇德|161110268|供热收费管理模块（小区管理，房型管理，付款类型管理，年份供热价格管理，供热居民管理，住宅供热记录管理）
组员|罗妙忠|161110251|供热收费管理模块（住宅缴费记录管理，住宅供热退费管理，住宅停供记录管理，公建表管理）
组员|吴澍淼|161110264|系统安全模块（登录管理，系统操作员管理，系统功能配置）
组员|张晓龙|161110254|供热收费管理模块（供热公建管理，公建年度供热费管理，公建缴费记录管理，公建退费记录管理）
组员|万俊星|161110259|客户服务模块（投诉管理，文件管理，通知管理）
组员|刘续智|161110283|供热收费管理模块（公建缴费记录管理，公建退费记录管理）
****************************
